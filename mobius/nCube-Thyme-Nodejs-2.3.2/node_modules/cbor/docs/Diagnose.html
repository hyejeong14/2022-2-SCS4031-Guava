...
<head>
    ...
    <title>Diagnose - Documentation</title>
...
<header>
        ...
        Diagnose
            ...
            <div class="class-description">Output the diagnostic format from a stream of CBOR bytes.</div>
...
<div class="section-method">
    ...
    <h4 class="name" id="Diagnose"><span class="type-signature"></span>new Diagnose<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="diagnose.js.html">diagnose.js</a>, <a href="diagnose.js.html#line19">line 19</a>
    </li></ul></dd>
...
<span class="param-type"><code>string</code></span>
        ...
        <tr>
                ...
                <td class="name"><code>stream_errors</code></td>
...
<div class="section-method">
    ...
    <h4 class="name" id=".diagnose"><span class="type-signature">(static) </span>diagnose<span class="signature">(input, encoding<span class="signature-attributes">opt</span>, cb)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="diagnose.js.html">diagnose.js</a>, <a href="diagnose.js.html#line78">line 78</a>
    </li></ul></dd>
...
<span class="param-type"><code>string</code></span>
            ...
            <td class="description last">
                the encoding of input, ignored if input is Buffer
...
<span class="param-type"><code><a href="global.html#commentCallback">commentCallback</a></code></span>
