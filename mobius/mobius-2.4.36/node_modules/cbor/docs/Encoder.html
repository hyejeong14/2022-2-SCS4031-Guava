...
<head>
    ...
    <title>Encoder - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Encoder</h1>
...
<header>
        ...
        Encoder
            ...
            <div class="class-description">Transform JavaScript values into CBOR bytes.  The `Writable` side of
the stream is in object mode.</div>
...
<div class="section-method">
    ...
    <h4 class="name" id="Encoder"><span class="type-signature"></span>new Encoder<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="encoder.js.html">encoder.js</a>, <a href="encoder.js.html#line32">line 32</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>genTypes</code></td>
...
<span class="param-type"><code>Array.&lt;any></code></span>
  ...
  for Array, Date, Buffer, Map, RegExp, Set, Url, or bignumber.
        ...
        <tr>
                ...
                <td class="name"><code>canonical</code></td>
...
<div class="section-method">
    ...
    <h4 class="name" id=".encode"><span class="type-signature">(static) </span>encode<span class="signature">(&hellip;objs)</span><span class="type-signature"> &rarr; {Buffer}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="encoder.js.html">encoder.js</a>, <a href="encoder.js.html#line471">line 471</a>
    </li></ul></dd>
...
<div class="section-method">
    ...
    <h4 class="name" id=".encodeCanonical"><span class="type-signature">(static) </span>encodeCanonical<span class="signature">(&hellip;objs)</span><span class="type-signature"> &rarr; {Buffer}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="encoder.js.html">encoder.js</a>, <a href="encoder.js.html#line483">line 483</a>
    </li></ul></dd>
...
<div class="section-method">
    ...
    <h4 class="name" id="addSemanticType"><span class="type-signature"></span>addSemanticType<span class="signature">(type, fun)</span><span class="type-signature"> &rarr; {<a href="global.html#encodeFunction">encodeFunction</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="encoder.js.html">encoder.js</a>, <a href="encoder.js.html#line94">line 94</a>
    </li></ul></dd>
...
<span class="param-type"><code><a href="global.html#encodeFunction">encodeFunction</a></code></span>
...
<div class="section-method">
    ...
    <h4 class="name" id="pushAny"><span class="type-signature"></span>pushAny<span class="signature">(obj)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="encoder.js.html">encoder.js</a>, <a href="encoder.js.html#line415">line 415</a>
    </li></ul></dd>
